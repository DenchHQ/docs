---
title: "Dench agent skill for AI coding tools"
description: "The Dench agent skill explains how an AI agent should connect to a workspace, read context, claim tasks, log progress, and request approval before risk."
---
