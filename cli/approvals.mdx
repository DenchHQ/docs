---
title: "Approval commands in the Dench CLI"
description: "Request human approval before risky actions, then record the outcome with dench approval approve or reject — with evidence attached to every decision."
---
