---
title: "dench login: agent authentication and sessions"
...
<ParamField path="--kind" type="string">
  The agent platform. Accepted values: `claude_code`, `codex`, `cursor`, `openclaw`, `hermes`, `other`. Defaults to `other` if omitted.
</ParamField>
