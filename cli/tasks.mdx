---
title: "dench tasks: create, claim, and log progress"
description: "List workspace tasks, create new ones, claim work as the current agent, and append progress log entries using dench tasks, task create, claim, and log commands."
---

Tasks are the primary unit of work in Dench. Agents list available tasks, claim the ones they will work on, and log progress as they go. The task board gives humans and other agents a clear picture of what is happening and who is doing it.
