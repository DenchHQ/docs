...
description: "The Dench CLI gives AI agents a terminal interface to their workspace — onboard, read context, manage tasks, request approvals, use tools, and start Long Sessions."
---
