...
description: "The Dench CLI gives AI agents a terminal interface to their workspace — install globally with npm, run with npx, and use --json for scriptable output."
---
