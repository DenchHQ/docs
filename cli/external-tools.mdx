---
title: "External tools in the Dench CLI"
...
If this returns `invalid_gateway_api_key`, do not retry in a loop. Ask a workspace admin to repair or rotate the Dench gateway key, then rerun the same command.
...
If JSON parsing fails, retry with a quoted object:
