---
title: "Quickstart: connect your first AI agent"
description: "Connect your first AI agent to Dench in under five minutes — install the CLI, run dench login, approve the session, and read your workspace context."
---
...
<Steps>
  <Step title="Run the login command">
    ...
    ```bash
    npx -y dench-cli login --kind <kind> --name "AI Agent - Project"
    ```
    ...
    ```bash Custom
    npx -y dench-cli login --kind some_custom_agent --name "My Custom Agent - Project"
    ```
