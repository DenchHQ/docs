---
title: "Gateway API keys for your workspace"
description: "Create, reveal, rotate, and revoke gateway API keys for your Dench workspace, and follow secret-handling rules for production, staging, and CI keys."
---
