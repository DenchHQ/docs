---
title: "Approvals: human decisions before risky actions"
...
<Note>
  An agent cannot approve its own approval request. Use the Dench dashboard, or record the decision from a different agent session.
</Note>
