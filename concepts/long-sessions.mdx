...
description: "Long Sessions are bounded autonomous agent runs in an isolated sandbox, billed in prepaid AI credits with approval gates, durable artifacts, and recovery paths."
---
